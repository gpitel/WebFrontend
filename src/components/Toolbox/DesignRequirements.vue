...
export default {
    ...
    methods: {
        ...
        // Gather every per-lead connection.type across all windings (source of truth).
        allConnectionTypes() {
                    ...
                    <div class="row ms-5 mt-1" v-if="terminalMode == $stateStore.MagneticBuilderModes.Basic">
                        <div class="col-12 d-flex align-items-center gap-2">
                            ...
                            <select
                                ...
                                <option v-for="opt in connectionTypeValues" :key="opt" :value="opt">{{ connectionTypeLabels[opt] || opt }}</option>
                            </select>
                        </div>
                    </div>
